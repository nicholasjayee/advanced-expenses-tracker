...
async def run():
    async with async_playwright() as p:
        ...
        try:
            ...
            # "Add New Expense" is likely a button or header on the expenses page
            print("Waiting for page content...")
            await page.wait_for_selector("text=Add New Expense", timeout=10000)
            ...
            await page.wait_for_timeout(2000)
            await page.screenshot(path="expenses_charts_screenshot.png", full_page=True)
            print("Charts screenshot taken successfully")
