...
export const ExpenseCharts: React.FC<ExpenseChartsProps> = ({ expenses }) => {
  ...
  const topExpenses = useMemo(() => {
      ...
      // Replaced O(N log N) full array sort with an O(N) single-pass algorithm
      // to keep track of the top 5 expenses, significantly improving render
      // speed for components with high transaction volumes.
      const top: Expense[] = [];
