...
export const ExpenseCharts: React.FC<ExpenseChartsProps> = ({ expenses }) => {
  ...
  const topExpenses = useMemo(() => {
      ...
      // maintaining a sorted array of the top 5 expenses.
      // Expected impact: Faster rendering for large expense datasets by avoiding unnecessary array allocation and sorting overhead.
      const top: Expense[] = [];
