          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className={`w-full bg-background border rounded-lg pl-8 p-3 text-white focus:outline-none text-xl font-bold ${isOverdraft ? 'border-danger focus:border-danger' : 'border-border focus:border-primary'}`}
                placeholder="0.00"
                min="0.01"
                step="0.01"
                required
