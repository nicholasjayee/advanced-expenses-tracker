    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-surface border border-border rounded-xl w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-200">
        <div className="flex justify-between items-center p-5 border-b border-border">
          <h2 className="text-xl font-bold text-white">Top Up Funds</h2>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-background border border-border rounded-lg pl-8 p-3 text-white focus:border-primary focus:outline-none text-xl font-bold"
                placeholder="0.00"
                min="0.01"
                step="0.01"
                required
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea 
                ...
                className="w-full bg-background border border-border rounded-lg pl-10 p-2.5 text-white focus:border-primary focus:outline-none text-sm min-h-[80px] resize-none"
